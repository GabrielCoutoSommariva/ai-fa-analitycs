...
('vendas.vendas_cab', 'vendas', 'Cabecalho do cupom/venda PDV. Responde perguntas de faturamento, cupons, loja, cliente, caixa, status e datas.', '1 linha por venda/cupom', 'data', array['id','id_associado','id_loja','id_cliente','nro_venda','ticket','data','status','st_caixa','vlr_liquido','vlr_produto','vlr_servico','vlr_devolucao'], array['cpf_nf','obs_venda','obs_caixa'], 'KPIs executivos consideram st_caixa in (''PA'', ''DP''); DV fica para analise de devolucao total.'),
...
('faturamento_diario', 'Faturamento diario', 'Quanto vendi em um dia?', 'analytics.kpi_faturamento_diario', 'data', 'faturamento_liquido', 'Usa valor ajustado por devolucao.', 'sum(vendas_cab.vlr_liquido - vendas_cab.vlr_devolucao) agrupado por data, associado e loja, filtrando st_caixa in (''PA'', ''DP'').', 'DV fica fora dos KPIs executivos e permanece disponivel para analise de devolucao total.'),
('faturamento_mensal', 'Faturamento mensal', 'Quanto vendi no mes?', 'analytics.kpi_faturamento_mensal', 'mes', 'faturamento_liquido', 'Usa valor ajustado por devolucao.', 'sum(vendas_cab.vlr_liquido - vendas_cab.vlr_devolucao) agrupado por mes, associado e loja, filtrando st_caixa in (''PA'', ''DP'').', 'DV fica fora dos KPIs executivos e permanece disponivel para analise de devolucao total.'),
